        ...
        Container(
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: TextStyle(
                color: !enabled
                    ? R.colors.greyTextPrimary.withOpacity(0.4)
                    : R.colors.greyTextPrimary,
                fontSize: 14.sp,
                letterSpacing: 0.12.w,
              ),
              errorStyle: TextStyle(
                fontSize: 12.sp,
                color: R.colors.errorRed,
              ),
              errorMaxLines: 2,
              filled: false,
              ...
              focusedErrorBorder: OutlineInputBorder(
                borderSide: BorderSide(color: R.colors.errorRed),
              ...
              enabledBorder: OutlineInputBorder(
                borderSide: BorderSide(
                    color: enabledBorderColor ?? R.colors.greyBorder),
                borderRadius: BorderRadius.circular(radius.r),
              ),
              disabledBorder: OutlineInputBorder(
                borderSide: BorderSide(
                  color: R.colors.greyBorder.withOpacity(0.4),
                ),
                borderRadius: BorderRadius.circular(radius.r),
              ),
              focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(radius.r),
                borderSide: BorderSide(
                    color: focusedBorderColor ?? R.colors.greyBorder),
              ),
